...
exports.default = {
  ...
  methods: {
    setCategory: function setCategory(index, name) {
      var category = {
        "id": index,
        "name": name
      };
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<form action=\"\">\n\n  <legend>Category Selection</legend>\n    <span class=\"option-item\" v-for=\"category in categories\">\n      <input type=\"radio\" name=\"category\" id=\"{{ category.name | lowercase }}\" data-index=\"{{ category.id }}\">\n      <label @click=\"setCategory(category.id, category.name)\" for=\"{{ category.name | lowercase }}\">{{ category.name }}</label>\n    </span>\n\n</form>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/CategorySelection.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"./OptionItem.vue":82,"babel-runtime/core-js/json/stringify":1,"vue":62,"vue-hot-reload-api":36,"vueify-insert-css":63}],68:[function(require,module,exports){
"use strict";
...
exports.default = {
  ...
  ready: function ready() {
    this.$http.get('http://localhost:8080/services/classification').then(function (response) {
  ...
  methods: {
    setClassification: function setClassification(id, name) {
      var detail = {
        "id": id,
        "name": name
      };
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<form method=\"\" action=\"\">\n  <legend>Classification Selection</legend>\n\n    <span class=\"option-item\" v-for=\"classification in classifications\">\n      <input type=\"checkbox\" name=\"classification\" id=\"{{ classification.name | lowercase }}\" data-index=\"{{ classification.id }}\">\n      <label @click=\"setClassification(classification.id, classification.name)\" for=\"{{ classification.name | lowercase }}\">{{ classification.name }}</label>\n    </span>\n\n    <button @click.prevent=\"setClassifications\" class=\"btn side-bar-confirm\">Confirm</button>\n\n</form>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/ClassificationSelection.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"babel-runtime/core-js/json/stringify":1,"vue":62,"vue-hot-reload-api":36}],69:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\nth {\n  text-align: left;\n}\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/ClientList.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/ClientSearchForm.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":62,"vue-hot-reload-api":36,"vueify-insert-css":63}],73:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/DatePeriodForm.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      types: [{ name: "text" }, { name: "number" }, { name: "date" }, { name: "true/false" }]
    };
  },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/jm/Development/SE3/SE3-Fothebys-Desktop/resource/assets/vue/components/ExpertSelection.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
exports.default = {
  ...
  ready: function ready() {
    ...
    if (category !== null) {
      ...
      this.$http.get(path + category.id).then(function (response) {
        this.$data.category = response.data;
      }, function (response) {});
    }
  }
...
},{"vue":62,"vue-hot-reload-api":36,"vueify-insert-css":63}],78:[function(require,module,exports){
"use strict";
...
exports.default = {
  ...
  ready: function ready() {
    this.measures = [{ name: "Metric", units: ['m', 'cm', 'mm'] }, { name: "Imperial", units: ['yd', 'ft', 'in'] }];
  },
...
exports.default = {
  ...
  methods: {
    ...
    makeList: function makeList(details) {
...
},{"./Tile.vue":85,"vue":62,"vue-hot-reload-api":36}],84:[function(require,module,exports){
"use strict";
...
//   }
// })
},{"./components/AddLotItem.vue":64,"./components/App.vue":65,"./components/ArrangeAppraisal.vue":66,"./components/ClientDetails.vue":69,"./components/ClientList.vue":71,"./components/DefineCategories.vue":74,"./components/LotAppraisal.vue":81,"./components/PageNav.vue":83,"./components/Welcome.vue":86,"vue":62,"vue-resource":50,"vue-router":61}]},{},[87]);
